  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mt-6 space-y-6">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">Personal Information We Collect</h3>

        <h4 className="text-lg font-medium mt-3 text-black dark:text-white">Device Information</h4>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h4 className="text-lg font-medium mt-3 text-black dark:text-white">Cookies</h4>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h4 className="text-lg font-medium mt-3 text-black dark:text-white">Log Files</h4>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h4 className="text-lg font-medium mt-3 text-black dark:text-white">Web Beacons, Tags, and Pixels</h4>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">How Do We Use Your Personal Information?</h3>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">Data Retention</h3>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">Data Privacy Changes</h3>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">Security of Your Information</h3>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-xl font-semibold mt-6 text-black dark:text-white">Policy for Children</h3>
        <p className="leading-relaxed text-gray-700 dark:text-gray-300">
