  ...
  return (
    <div className="faq-container">
      ...
      <div className="faq-content">
        ...
        <p><strong>Q: What is RED PC?</strong><br />
        ...
        <p><strong>Q: How can I contact customer support?</strong><br />
        A: You can reach customer support via email at redpcnow@gmail.com.</p>

        <h3>Product Specifications</h3>
        <p><strong>Q: How much RAM is recommended for general use?</strong><br />
        ...
        <p><strong>Q: SSD vs. HDD - What's the difference?</strong><br />
        ...
        <p><strong>Q: Which processor is best for gaming or professional tasks?</strong><br />
        ...
        <p><strong>Q: Can I cancel or modify my order after it is placed?</strong><br />
        ...
        <p><strong>Q: How long does standard shipping take?</strong><br />
        ...
        <p><strong>Q: Will I be able to track my order?</strong><br />
        ...
        <p><strong>Q: Do your products come with a warranty?</strong><br />
        ...
        <p><strong>Q: How can I reach out for warranty claims?</strong><br />
